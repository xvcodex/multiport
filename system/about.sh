...
figlet " BY NORULEZZX" | lolcat
echo -e "\e[32;1m.-----------------------------------------------.\e[0m"
echo -e "\e[32;1m|               \e[36;1mINFO SCRIPT VPS\e[0m                 \e[32;1m|\e[0m"
echo -e "\e[32;1m'-----------------------------------------------'\e[0m"
echo -e "           \e[031;1m> Premium Script By NORULEZZX <\e[0m" | lolcat
...
echo -e "\e[0;32m|  \e[1;35mFor VPS with KVM and VMWare NORULEZZX         \e[0;32m|\e[0m"
