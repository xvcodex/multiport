...
patchtls=/diyvpn-vmesswstls
patchnontls=/diyvpn-vmesswsntls
...
patchtls=/diyvpn-vlesswstls
patchnontls=/diyvpn-vlesswsntls
uuid=$(cat /proc/sys/kernel/random/uuid)
read -p "   Bug Address (Example: www.google.com) : " address
read -p "   Bug SNI/Host (Example : m.facebook.com) : " sni
read -p "   Expired (days) : " masaaktif
...
patchtls=/diyvpn-trojanwstls
patchnone=/diyvpn-trojanwsntls
read -p "   Bug Address (Example: www.google.com) : " address
