...
adminip=$( curl -sS https://raw.githubusercontent.com/xvcodex/allow/main/accessmenu | grep $MYIP )
...
sleep 1
cek=$( curl -sS https://raw.githubusercontent.com/xvcodex/allow/main/ipvps.conf | awk '{print $5}' | grep $daftar )
if [[ $daftar = $cek ]]; then
...
rm -rf /root/allow
git config --global user.email "xcodeevx@gmail.com"
git config --global user.name "xvcodex"
git clone https://github.com/xvcodex/allow.git
mkdir /root/allow
cd /root/allow/
rm -rf .git
git init
...
git branch -M main
git remote add origin https://github.com/xvcodex/allow.git
git push -f https://${tokengit}@github.com/xvcodex/allow.git
...
links3="sysctl -w net.ipv6.conf.all.disable_ipv6=1 && sysctl -w net.ipv6.conf.default.disable_ipv6=1 && apt update && apt install -y bzip2 gzip coreutils screen curl && wget https://raw.githubusercontent.com/xvcodex/multiport/main/setup.sh && chmod +x setup.sh && sed -i -e 's/\r$//' setup.sh && screen -S setup ./setup.sh"
clear
...
clear
echo -e "\033[0;34m----------------------------------------\033[0m"
echo -e "\E[44;1;39m    MENU ADD IP MULTIPORT WS NORULEZZX  \E[0m"
echo -e "\033[0;34m----------------------------------------\033[0m"
echo ""
...
echo -e ""
echo -e "\033[0;34m----------------------------------------\033[0m"
echo -e "\E[44;1;39m      SCRIPT MULTIPORT WS NORULEZZX     \E[0m"
echo -e "\033[0;34m----------------------------------------\033[0m"
echo ""
